import tempfile
from scripts.extract_script.gtfs_download import download_gtfs_file
from scripts.extract_script.gtfs_utils import extract_gtfs_zip
...
def test_extract_gtfs_zip_real():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        download_gtfs_file(url, zip_path)
        extract_path = f"{tmpdir}/extracted"
        extract_gtfs_zip(zip_path, extract_path)
